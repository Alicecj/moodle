...
$string['choosereadme'] = '<p>Alice is a theme that allows you to easily customise Moodle\'s look and feel directly from the web interface.</p>
<p>Visit the admin settings to change colours, add an image as a background, add your logo and alice.</p>';

$string['configtitle'] = 'Alice';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'The logo is only displayed in the header of the front page and login page.<br /> If the height of your logo is alice than 75px add div.logo {height: 100px;} to the Custom CSS box below, amending accordingly if the height is other than 100px. If a logo is not added here, the logo in Appearance > Logos will be used.';

$string['pluginname'] = "Alice's cool theme";
...
$string['footertextcolor_desc'] = 'The colour of the Footer text.';
$string['h2textcolor'] = 'h2 text colour';
$string['h2textcolor_desc'] = 'The colour of h2 text.';
$string['fontsize'] = 'Font size';
$string['fontsize_desc'] = 'The size of the Font.';
$string['coolfile'] = 'Cool File';
$string['coolfile_desc'] = 'Upload a cool file.';
